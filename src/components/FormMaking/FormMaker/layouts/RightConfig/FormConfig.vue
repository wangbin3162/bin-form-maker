      ...
      <b-scrollbar>
        <div class="comp-config-container">
          <div v-if="curTabActive === 'base'">
            <CfgField label="标签对齐" :labelWidth="labelWidth">
            ...
            <CfgField label="标签宽度" :labelWidth="labelWidth">
              <b-input-number
            ...
            <CfgField label="标签后缀" :labelWidth="labelWidth">
              <b-input v-model="data.labelSuffix" :size="size" clearable />
            </CfgField>

            <CfgField label="组件尺寸" :labelWidth="labelWidth">
...
<script setup>
import { ref } from 'vue'
import EventsCfg from './EventsCfg/index.vue'
